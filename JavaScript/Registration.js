...
function sendMessage(name, email, gyear, Branch, college_ID) {
  firebase.database().ref('register/'+college_ID).set({
    name: name,
    email: email,
    gyear: gyear,
    Branch: Branch,
